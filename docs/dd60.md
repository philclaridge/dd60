...
The DD60 emulation uses a three-level scaling system to accommodate both hardware-authentic CDC 6602 character sizing and modern high-resolution displays, including Apple Retina displays.
...
```
DD60_C{character}_R{canvas}_D{device}
```

Examples:
- `DD60_C1_R1_D1`: Character x1, 512 canvas, standard display
- `DD60_C2_R2_D2`: Character x2, 1024 canvas, Retina display  
- `DD60_C4_R4_D2`: Character x4, 2048 canvas, Retina display
